...
import com.github.ristinak.Fingers.Finger
//more examples here
...
//notice object so singleton meaning we only have one com.github.ristinak.Color object
...
object Fingers extends Enumeration {
  type Finger = Value //so all com.github.ristinak.Fingers have same type of Value
...
object Day16Enumerations extends App {
  ...
  println("How about the com.github.ristinak.Fingers?")
